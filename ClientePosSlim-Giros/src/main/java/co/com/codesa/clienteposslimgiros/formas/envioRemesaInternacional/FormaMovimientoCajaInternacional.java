...
import co.com.codesa.clienteposslimgiros.eventos.envioRemesaInternacional.EventoFormaMovimientoCajaInternacional;
...
public class FormaMovimientoCajaInternacional extends FormaGenerica{
	...
	/**
  	 ...
  	 * ****************************************************************
  	 */
	public FormaMovimientoCajaInternacional(FormaGenerica pFrmPadre, 
							   boolean pBooModal, 
		...
		super.setEventoForma(new EventoFormaMovimientoCajaInternacional(this,
				 			 							   pObjFacturaGiro));
	...
	public static void main(String[] args) {
		...
		try{
			...
			TestPruebasInternas.getInstance().iniciarPruebaInterna(FormaMovimientoCajaInternacional.class,
																   true, 
																   EnumDesplegarFormaConEventos.SI);
			FacturaGiroInternacional factG = new FacturaGiroInternacional();
			factG.setTotal(100000);
			Documento doc = new Documento();
			doc.setNaturaleza("+");
			doc.setCodigo("27");
			factG.setDocumento(doc);
			new FormaMovimientoCajaInternacional(null,
									true,  
									factG);
