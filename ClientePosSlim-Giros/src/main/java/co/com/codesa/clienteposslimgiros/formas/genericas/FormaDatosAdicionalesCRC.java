 ...
 * ****************************************************************
 */
public class FormaDatosAdicionalesCRC extends FormaGenerica{
	
	/**
	 * @variable 	serialVersionUID
	 * 			 	Variable serialVersionUID
	 */
	private static final long serialVersionUID = 555029796166645662L;
	...
	/**
  	 ...
  	 * ****************************************************************
  	 */
	public FormaDatosAdicionalesCRC(FormaGenerica pFrmPadre,
						  		 boolean pBooModal,
	...
	public static void main(String[] args) {
		...
		JPanel pnlDatAdiPrueba = null;
		
		try {
		
			pnlDatAdiPrueba = UtilComponentesGUI.getInstance().crearPanel(EnumDimensionesComponentes.PNL_AQC_DAT_ADI_CHEQUE,
																		  "pnlDatAdiPrueba",
	  																   	  null,
	  																   	  null,
	  																   	  null);
			
			new FormaDatosAdicionalesCRC(null, 
									  true, 
									  pnlDatAdiPrueba);
