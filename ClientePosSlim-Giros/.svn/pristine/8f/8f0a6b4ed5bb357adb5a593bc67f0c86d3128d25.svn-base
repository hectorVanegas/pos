...
/** 
 * ********************************************************************
 * @class  FormaPanelDesplazableGenerico
 *		   Clase que permite generalizar los comportamientos y atributos
 *		   de una forma concebida como una seccion desplazable, similar 
 *		   al proposito de la FormaPanelGenerico para las funcionalidades 
 *		   basicas del sistema
 ...
 * *********************************************************************
 */
public abstract class FormaPanelDesplazableGenerico extends SeccionDesplazableUtil{
	...
	**/
	 ...
	 * 
	 * ********************************************************************
	 * @method FormaPanelDesplazableGenerico
	 * 		   Constructor de la seccion desplazable generica, que se encarga 
	 * 		   de inicializar los atributos y comportamientos en el proceso 
	 * 		   de construccion
	 * @param  pFrmGnrPadre
	 * 		   Referencia a la forma generica que contiene la seccion 
	 * @param  pEnmDimension
	 ...
	 * *********************************************************************
	 */
	public FormaPanelDesplazableGenerico(FormaGenerica pFrmGnrPadre,
	 ...
	 * 		   atributos para la construccion de una forma seccion 
	 * 		   desplazable, y proceder con la ejecucion de sentencias propias 
	 * 		   de inicializacion  
	 * @param  pFrmGnrPadre
	 * 		   Referencia a la forma generica que contiene la seccion 
	 * @param  pEnmDimension
	...
	/**
	 * ********************************************************************
	 * @method inicializarSeccionDesplazable
	 * 		   Metodo que permite ejecutar las sentencias particulares 
	 * 		   de inicializacion de la seccion desplazable
	 * @throws Exception
	 * 		   Controla, recupera y escala, cualquier tipo de excepcion 
	 * 		   presentada
	 * @author hector.cuenca
	 ...
	 * *********************************************************************
	 */
	protected abstract void inicializarSeccionDesplazable() throws Exception;
	
	/**
	 * ********************************************************************
	 * @method iniciar
	 * 		   Metodo propuesto por la seccion desplazable generica, para 
	 * 		   centralizar las acciones que permiten dar inicio a todo su 
	 * 		   despliegue
	 * @throws Exception
	 * 		   Controla, recupera y escala, cualquier tipo de excepcion 
  	 * 		   presentada
	...
	public void iniciar() throws Exception{
		...
		this.inicializarSeccionDesplazable();
		this.iniciarValores();
	}
