...
import co.com.codesa.clienteposslimgiros.eventos.superCombo.EventoFormaSuperComboOrigen;
 ...
 * ****************************************************************
 */
public class FormaSuperComboOrigen extends FormaGenerica{
	...
	public FormaSuperComboOrigen(FormaGenerica pFrmPadre, 
								 boolean pBooModal,
		...
		super.setEventoForma(new EventoFormaSuperComboOrigen(this,
															 pStrValSuperCombo,
															 pFactura));
	...
	public void inicializarForma(Object... pArrObjParametrosForma) throws Exception {
		...
		super.setAnchoForma(EnumDimensionesComponentes.FRM_SCO_VENTANA.getAncho());
		super.setAltoForma(EnumDimensionesComponentes.FRM_SCO_VENTANA.getAlto());
	...
	public EtiquetaUtil iniciarPropLblDeseaIncluir() throws Exception{
		...
		this.lblDeseaIncluir = UtilComponentesGUI.getInstance().crearLabel(EnumDimensionesComponentes.LBL_SCO_DESEA_INCLUIR, 
																	   	   "lblDeseaIncluir", 
	...
	public EtiquetaUtil iniciarPropLblValorSuperCombo() throws Exception{
		...
		this.lblValorSuperCombo = UtilComponentesGUI.getInstance().crearLabel(EnumDimensionesComponentes.LBL_SCO_VALOR_SUPERCOMBO, 
																	   	  	  "lblValorSuperCombo", 
	...
	public EtiquetaUtil iniciarPropLblVlrSuperCombo() throws Exception{
		...
		this.lblVlrSuperCombo = UtilComponentesGUI.getInstance().crearLabel(EnumDimensionesComponentes.LBL_SCO_VLR_SUPERCOMBO, 
																	   		"lblVlrSuperCombo", 
																	   		null,
																	   		false,
																	   		null,
