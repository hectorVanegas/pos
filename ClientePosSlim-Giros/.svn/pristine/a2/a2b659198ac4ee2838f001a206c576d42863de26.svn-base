package co.com.codesa.clienteposslimgiros.formas.serviciosAdicionales.SMSGiro;
...
import co.com.codesa.clienteposslimgiros.eventos.serviciosAdicionales.SMSGiro.EventoFormaPanelSMSGiro;
 ...
 * *********************************************************************
 */
public class FormaPanelSMSGiro extends FormaPanelGenerico {
	 ...
	 * *********************************************************************
	 */
	public FormaPanelSMSGiro(	FormaGenerica pFrmGnrVentana,
	...
	{	
		...
		super.setEvaControlEventos(new EventoFormaPanelSMSGiro	(	this,
																	pStrTelefonoCelular
																));
	...
	@Override
	public EventoFormaPanelSMSGiro getEvaControlEventos() 
	{
		return (EventoFormaPanelSMSGiro)super.getEvaControlEventos();
	};
	...
	public static void main(String args[]){
		...
		try {
			...
			FormaPanelSMSGiro forma;
			
			forma = new FormaPanelSMSGiro(null,
					EnumDimensionesComponentes.PNL_PNL_SMS_SECCION,
